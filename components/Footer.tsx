      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col gap-4">
            <div className="text-xl font-black text-violet-400">SY</div>
            <div className="text-white/45 text-sm leading-relaxed">
              Frontend developer crafting beautiful and performant web applications.
            </div>
          </div>

          {/* Quick links */}
          <div className="flex flex-col gap-4">
            <div className="text-white/70 font-semibold text-sm">Quick Links</div>
          ...
          {/* Contact */}
          <div className="flex flex-col gap-4">
            <div className="text-white/70 font-semibold text-sm">Contact</div>
            <div className="flex flex-col gap-2.5">
              <div className="text-white/40 text-sm">{portfolioData.personal.email}</div>
              <div className="text-white/40 text-sm">{portfolioData.personal.location}</div>
            </div>
          </div>
            ...
            <div className="flex gap-3">
              {portfolioData.social.map((social) => (
                <a
                  ...
                  className="size-9 rounded-lg card card-hover flex items-center justify-center text-white/50 hover:text-white transition-colors duration-200"
                  title={social.name}
                >
